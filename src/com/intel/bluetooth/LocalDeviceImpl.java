 ...
 *
 */
public class LocalDeviceImpl extends LocalDevice {
	
	private static LocalDeviceImpl localDevice;

	private static DiscoveryAgentImpl discoveryAgent;

	private static long bluetoothAddress;

	
	private LocalDeviceImpl() throws BluetoothStateException{
		super(null);
		NativeLibLoader.isAvailable();
		discoveryAgent = new DiscoveryAgentImpl();

		bluetoothAddress = getLocalAddress();
		
		btTextAddress = Long.toHexString(bluetoothAddress);

		btTextAddress = "000000000000".substring(btTextAddress.length()) + btTextAddress;
	}

	private native long getLocalAddress() throws BluetoothStateException;
	...
	public static LocalDevice getLocalDevice() throws BluetoothStateException {
		if (localDevice == null)
			localDevice = new LocalDeviceImpl();
	...
	public native boolean setDiscoverable(int mode) throws BluetoothStateException;
