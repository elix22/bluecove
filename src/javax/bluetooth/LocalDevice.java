...
public class LocalDevice {
    ...
    */
    ...
    protected LocalDevice(Object distinguishment) {
    ...
    */
    public static LocalDevice getLocalDevice() throws BluetoothStateException {
    	return com.intel.bluetooth.LocalDeviceImpl.getLocalDevice();
    } 
    ...
    */
    public static String getProperty(String property) {
    	return com.intel.bluetooth.LocalDeviceImpl.getProperty(property);
