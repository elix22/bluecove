...
public class RemoteDevice {
	...
	/**
	 * Determines if two {@code RemoteDevices} are equal. Two devices are equal if
	 * they have the same Bluetooth device address. 
	 * 
	 * @param obj the object to compare to 
	 * @return {@code true}
	 * if both devices have the same Bluetooth address; {@code false} if both devices do
	 * not have the same address; {@code false} if obj is {@code null}; {@code false} if obj is not a
	 * {@code RemoteDevice}
	 */
