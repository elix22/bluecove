...
class BluetoothEmulator implements BluetoothStack, DeviceInquiryRunnable, SearchServicesRunnable {
	...
	public int runDeviceInquiry(DeviceInquiryThread startedNotify, int accessCode, DiscoveryListener listener)
		...
		try {
			...
			for (int i = 0; i < devices.length; i++) {
				RemoteDevice remoteDevice = RemoteDeviceHelper.createRemoteDevice(this, devices[i].getAddress(), devices[i].getName(), false);
	...
	public void deviceDiscoveredCallback(DiscoveryListener listener,
			long deviceAddr, int deviceClass, String deviceName, boolean paired) {
	}
...
//	}
	...
	public void connectionRfCloseClientConnection(long handle)
			throws IOException {
		// TODO Auto-generated method stub
		
	}

	public void connectionRfCloseServerConnection(long handle)
			throws IOException {
		// TODO Auto-generated method stub
	...
	public long connectionRfOpenClientConnection(
			BluetoothConnectionParams params) throws IOException {
		// TODO Auto-generated method stub
		return 0;
	}

	public long l2OpenClientConnection(BluetoothConnectionParams params,
	...
	public long rfServerAcceptAndOpenRfServerConnection(long handle)
			throws IOException {
		// TODO Auto-generated method stub
		return 0;
	}
	...
	public void rfServerUpdateServiceRecord(long handle,
			ServiceRecordImpl serviceRecord, boolean acceptAndOpen)
			throws ServiceRegistrationException {
		// TODO Auto-generated method stub
