...
public class ServiceRecordTester {
	...
	private static void buildAllTestServiceAttributes() {
		try {
			// allTestServiceAttributes.addElement(new
			...
			allTestServiceAttributes.addElement(new DataElement(DataElement.U_INT_8, new byte[] { 1, -2, 3, 4, -5, 6,
					7, -8 }));
			allTestServiceAttributes.addElement(new DataElement(DataElement.INT_16, new byte[] { 11, -22, 33, 44, -5,
					6, 77, 88, 9, -10, 11, 12, -13, 14, 15, 16 }));
			...
			// allTestServiceAttributes.addElement(new
			// DataElement(DataElement.UUID, new
			// UUID("E10C0FE1121111A11111161911110003", false)));

			allTestServiceAttributes.addElement(new DataElement(DataElement.STRING, "BlueCove-2007"));
			allTestServiceAttributes.addElement(new DataElement(DataElement.STRING, CommunicationData.stringUTFData));
			...
			// seq1.addElement(new DataElement(DataElement.URL,
			// "http://blueCove/"));
