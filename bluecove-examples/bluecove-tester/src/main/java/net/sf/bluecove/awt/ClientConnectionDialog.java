...
public class ClientConnectionDialog extends Dialog {
	...
	public ClientConnectionDialog(Frame owner) {
		...
		panelItems.add(l);
		panelItems.add(tfURL = new TextField());
		c.gridwidth = 1;
		...
		if (Configuration.storage != null) {
			tfURL.setText(Configuration.storage.retriveData("connectionURL"));
		}
	...
	protected void connect() {
		...
		if (Configuration.storage != null) {
			Configuration.storage.storeData("connectionURL", tfURL.getText());
		}
