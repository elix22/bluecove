...
public class RemoteDevice {
	...
	/**
	 * A lower case bluetooth hex address
	 */
    ...
    protected RemoteDevice(String address) {
    	...
    	try {
    	if(LocalDevice.getLocalDevice().getBluetoothAddress().equals(address))
    		throw new IllegalArgumentException();
    	} catch (BluetoothStateException exp) {
    		// hmm, what to do
    		// for now ignore it
    		System.err.println("Unable to access LocalDevice while constructing a" +
    				" remote device!");
    	}
    ...
    public boolean equals(Object obj) {
    	...
    	if( (obj instanceof RemoteDevice) &&
    		( ((RemoteDevice)obj).textAddress.equals(textAddress) ) )
    			return true;
    	else return false;
    }
